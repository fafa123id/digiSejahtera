    ...
    <AuthenticatedLayout>
        ...
        >
            ...
            <p class="mt-2 max-w-3xl text-sm leading-6 text-blue-50/90">
                Tampilkan rincian potongan bulanan seluruh anggota koperasi
        ...
        >
            ...
            <p class="mt-3 text-xs leading-5 text-slate-400">
                Periode {{ selectedMonthLabel }} {{ selectedYear }}. KITIR hanya
                menampilkan transaksi yang tercatat pada periode tersebut dan
                saldo pinjaman anggota sampai akhir periode.
            </p>
        </section>
